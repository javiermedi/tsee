...
$respuestaCot = ControladorService::ctrMostrarOrdenService($itemCot, $valorCot);

$fecha = substr($respuestaCot["fecha"],0,-8);
$productos = json_decode($respuestaCot["productos"], true);
$servicios = json_decode($respuestaCot["servicios"], true);
...
$itemCliente = "id";
$valorCliente = $respuestaCot["id_cliente"];

$respuestaCliente = ControladorClientes::ctrMostrarClientes($itemCliente, $valorCliente);

$itemVendedor = "id";

$valorVendedor = $respuestaCot["id_vendedor"];
...
$bloque3 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<td style="border: 1px solid #666; background-color:white; width:280px; text-align:center">Costo.</td>
...
$pdf->Output('Orden-Servicio.pdf', 'D');
