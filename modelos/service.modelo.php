...
# =============================================================================
 ...
 static public function mdlIngresarOrdenServicio($tablaS, $datosS){
 		...
 		$stmt = Conexion::conectar()->prepare("INSERT INTO $tablaS(id_vendedor, id_cliente, codigo, id_tecnico, productos, servicios, comentarios, sucursal, neto, total, totalP, totalS, codigoV, importe, cambio) VALUES (:id_vendedor, :id_cliente, :codigo, :id_tecnico, :productos, :servicios, :comentarios, :sucursal, :neto, :total, :totalP, :totalS, :codigoV, :importe, :cambio)");
 		...
 		$stmt -> bindParam(":sucursal", $datosS["sucursal"], PDO::PARAM_STR);
 ...
 # ===============================================
  ...
  static public function mdlEditarOrdenServicio($tablaS, $datosS){
    ...
    $stmt = Conexion::conectar()->prepare("UPDATE $tablaS SET id_vendedor = :id_vendedor, id_cliente = :id_cliente , codigo = :codigo, id_tecnico = :id_tecnico, productos = :productos, servicios = :servicios, comentarios = :comentarios, sucursal = :sucursal, neto = :neto, total = :total, totalP = :totalP, totalS = :totalS, codigoV = :codigoV, importe =:importe, cambio = :cambio WHERE  codigo = :codigo");
