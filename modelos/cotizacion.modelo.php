...
class ModeloCotiz{
	...
	static public function mdlCrearCotiz($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(remitente, codigo, cliente, productos, comentarios, descuento, neto, total, sucursal) VALUES (:remitente, :codigo, :cliente, :productos, :comentarios, :descuento, :neto, :total, :sucursal)");
