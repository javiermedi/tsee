...
class ModeloClientesI{
  ...
  ======================================-->*/
      ...
      echo '<script>
  		...
  		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, telefono, direccion, rfc, cfdi, servicio, contratacion, mensualidad) VALUES(:nombre, :telefono, :direccion, :rfc, :cfdi, :servicio, :contratacion, :mensualidad)");
  ...
  ======================================-->*/
    ...
    $stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, telefono = :telefono, direccion = :direccion, rfc = :rfc, cfdi = :cfdi, servicio = :servicio, contratacion = :contratacion, mensualidad = :mensualidad WHERE id = :id");
