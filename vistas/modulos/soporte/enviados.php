...
<div class="box box-primary">
    ...
    <div class="box-header with-border">
        ...
        <h3 class="box-title"><b>Mensajes Enviados </b> </h3>
        ...
        <div class="box-tools">
        	...
        	<div class="mailbox-controls pb-4">
                ...
                <a href="index.php?ruta=chat&soporte=enviados" class="btn btn-success btn-sm"><i class="fas fa-redo-alt"></i></a>
    ...
    <div class="box-body p-3 mailbox-messages">
        ...
        <input type="hidden" class="tipoMsj" value="enviados">
