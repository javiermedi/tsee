      	...
      	success:function(respuesta){
	          ...
	          '<div class="col-xs-6" style="padding-right:0px">'+
	            ...
	            '<div class="input-group">'+
	              ...
	              '<select class="form-control nuevaDescripcionProducto" idProducto="'+idProducto+'" id="producto'+numProducto+'" idProducto name="nuevaDescripcionProducto" required>'+
...
//CAMBIAR SELECT
$(".formularioVenta").on("change", "select.nuevoPrecioProduc", function(){
	...
	for(var i = 0; i < idProductos.length; i++){
		...
		for(var j = 0; j < botonesTabla.length; j ++){
			...
			if($(botonesTabla[j]).attr("idProducto") == boton){
				...
				$(botonesTabla[j]).removeClass("btn-info agregarProducto");
...
=============================================*/
$(".tablas").on("click", ".btnTicketVenta", function(){

  var codigoVenta = $(this).attr("codigoVenta");
						
	window.open("extensiones/tcpdf/pdf/print.php?codigo="+codigoVenta, "_blank");
